...
final favoritesMoviesProvider =
    StateNotifierProvider<FavoritesMoviesNotifier, Map<int, Movie>>((ref) {
  final localStorageRepository = ref.watch(localStorageRepositoryProvider);

  return FavoritesMoviesNotifier(localStorageRepository);
});
...
class FavoritesMoviesNotifier extends StateNotifier<Map<int, Movie>> {
  ...
  FavoritesMoviesNotifier(this.localStorageRepository) : super({});
